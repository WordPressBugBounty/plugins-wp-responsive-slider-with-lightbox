    ...
    <div id="poststuff" > 
        <div id="post-body" class="metabox-holder columns-2" >  
            ...
            <div id="postbox-container-1" class="postbox-container"> 
                <div class="postbox"> 
                    <h3 class="hndle"><span></span><?php echo __('New DIVI AI Theme','wp-responsive-slider-with-lightbox'); ?></h3> 
                    <div class="inside">
...
function i13_th_lbox_modify_render_block_defaults($block_content, $block) { 

    $block_content=rswrlp_remove_extra_p_tags($block_content);
...
add_filter( 'render_block', 'i13_th_lbox_modify_render_block_defaults', 10, 2 );
